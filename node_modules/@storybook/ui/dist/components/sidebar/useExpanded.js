...
var initializeExpanded = function initializeExpanded(_ref) {
  ...
  return [].concat(_toConsumableArray(rootIds), _toConsumableArray(highlightedAncestors)).reduce(function (acc, id) {
    return Object.assign(acc, _defineProperty({}, id, true));
  }, {});
};
...
var useExpanded = function useExpanded(_ref2) {
  ...
  var getElementByDataItemId = (0, _react.useCallback)(function (id) {
    return containerRef.current && containerRef.current.querySelector("[data-item-id=\"".concat(id, "\"]"));
  }, [containerRef]);
  ...
  var updateExpanded = (0, _react.useCallback)(function (_ref4) {
    ...
    if (ids.length === 1) {
      var element = containerRef.current.querySelector("[data-item-id=\"".concat(ids[0], "\"][data-ref-id=\"").concat(refId, "\"]"));
  ...
  }, [data, selectedStoryId]); // Expand, collapse or select nodes in the tree using keyboard shortcuts.
