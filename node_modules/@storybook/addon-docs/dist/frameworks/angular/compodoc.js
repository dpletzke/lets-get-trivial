...
exports.extractComponentDescription = exports.extractArgTypes = exports.extractArgTypesFromData = exports.extractType = exports.findComponentByName = exports.checkValidCompodocJson = exports.checkValidComponentOrDirective = exports.getCompdocJson = exports.setCompodocJson = exports.isMethod = void 0;
...
var extractType = function extractType(property, defaultValue) {
  ...
  switch (compodocType) {
    ...
    default:
      {
        var enumValues = extractEnumValues(compodocType);
        return enumValues ? {
          name: 'enum',
          value: enumValues
        } : {
