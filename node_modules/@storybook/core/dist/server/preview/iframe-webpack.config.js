...
var reactPaths = {};
var storybookPaths = ['addons', 'addons', 'api', 'channels', 'channel-postmessage', 'components', 'core-events', 'router', 'theming', 'semver', 'client-api', 'client-logger'].reduce(function (acc, sbPackage) {
  return _objectSpread(_objectSpread({}, acc), {}, {
    [`@storybook/${sbPackage}`]: _path.default.dirname((0, _resolveFrom.default)(__dirname, `@storybook/${sbPackage}/package.json`))
  });
}, {});
...
var _default = async function _default({
  ...
  var dlls = await presets.apply('webpackDlls', []);
  ...
  return {
    ...
    resolve: {
      ...
      alias: _objectSpread(_objectSpread(_objectSpread({}, _paths.default), storybookPaths), reactPaths),
